...
from water_quality.constants import *
...
class DataValidationConfig:
    ...
    valid_train_file_path: str = os.path.join(
        data_validation_dir, DATA_VALIDATION_VALID_DIR, TRAIN_FILE_NAME
    )
    valid_test_file_path: str = os.path.join(
        data_validation_dir, DATA_VALIDATION_VALID_DIR, TEST_FILE_NAME
    )
    invalid_train_file_path: str = os.path.join(
        data_validation_dir, DATA_VALIDATION_INVALID_DIR, TRAIN_FILE_NAME
    )
    invalid_test_file_path: str = os.path.join(
        data_validation_dir, DATA_VALIDATION_INVALID_DIR, TEST_FILE_NAME
    )
...
class ModelEvaluationConfig:
    ...
    report_file_path: str = os.path.join(model_evaluation_dir, MODEL_EVALUATION_REPORT_NAME)
...
class ModelPusherConfig:
    trained_model_path: str = MODEL_PUSHER_SAVED_MODEL_DIR
    bucket_name = "water-model-bucket"
    s3_model_key_path: str = MODEL_PUSHER_S3_KEY
